...
source=(https://www.kernel.org/pub/linux/bluetooth/${pkgname}-${pkgver}.tar.{xz,sign}
	...
	0001-a2dp-Fix-crash-when-SEP-codec-has-not-been-initializ.patch
)
...
sha256sums=('9349e11e8160bb3d720835d271250d8a7424d3690f5289e6db6fe07cc66c6d76'
	    ...
	    'a068491fb3d5cce906953c2aeb0de08f10815a4ba7b3a1d4886672d856f69a31'
)
...
prepare() {
  ...
  patch -d "${pkgname}"-${pkgver} -p1 -i "${srcdir}"/0001-a2dp-Fix-crash-when-SEP-codec-has-not-been-initializ.patch
}
