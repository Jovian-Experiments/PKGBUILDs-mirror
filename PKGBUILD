...
_commit=20ac8204acbb0a9735e9b5de8fa814e95beabfe3
pkgver=0.1.21.20ac820
pkgrel=1
...
source=("git+ssh://git@gitlab.steamos.cloud/holo/$pkgname.git#commit=$_commit"
        ...
        'ashpd-0.11.0.tar.gz::https://github.com/bilelmoussaoui/ashpd/archive/51cc0b1109c1160f609563eb303979059738aaef.tar.gz'
...
sha256sums=('SKIP'
            ...
            'c5ffa84c4cb282914ef968baa7d8416c43b60e0ebfb601088823a2e5753caffd'
...
prepare() {
  ...
  cat << EOF >> .cargo/config.toml
    ...
    [source."git+https://github.com/bilelmoussaoui/ashpd?rev=51cc0b1109c1160f609563eb303979059738aaef"]
    git = "https://github.com/bilelmoussaoui/ashpd"
    rev = "51cc0b1109c1160f609563eb303979059738aaef"
    replace-with = "vendored-sources"
