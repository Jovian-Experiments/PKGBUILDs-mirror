...
pkgbase=linux-neptune-517-wip
_tag=5.17.0-valve1-wip
pkgver=${_tag//-/.}
pkgrel=2
pkgdesc='Linux'
url="https://gitlab.steamos.cloud/jupiter/linux-integration/-/tree/5.17/cristicc/wip-integration"
arch=(x86_64)
license=(GPL2)
makedepends=(
...
source=(
  "$_srcname::git+ssh://git@gitlab.steamos.cloud/jupiter/linux-integration.git#branch=5.17/cristicc/wip-integration"
