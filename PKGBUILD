...
pkgname=scx-scheds
gitname=scx
pkgver=1.0.15.linux.neptune.611
pkgrel=1
...
sha256sums=('f6ece09e1a6aa738e1555be60ad57a111a912ab1dbe17660796ddabd53facacc')
options=(!lto)
...
build() {
  ...
  meson compile -C build scx_lavd
}
...
package() {
  ...
  install -Dm755 "build/release/scx_lavd" "${pkgdir}/usr/bin/scx_lavd"
