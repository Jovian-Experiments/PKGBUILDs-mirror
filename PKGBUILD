...
source=(https://download.kde.org/stable/plasma/$pkgver/$pkgbase-$pkgver.tar.xz{,.sig} kde.pam
        ...
        0002-Big-backport-of-the-new-ScreenPool-logic.patch
        steam.desktop)
sha256sums=('2ebee6ab2f10cabc350e0f75a0d8462ae0b7616a795d078f6bb5765396052575'
            ...
            '4285500efd433e8dc3495e6768cae8c0dbd67bdabcb38f3a8dd667f5d64f6a37'
...
prepare() {
  ...
  patch -d $pkgbase-$pkgver -p1 --input="${srcdir}/0002-Big-backport-of-the-new-ScreenPool-logic.patch"
}
