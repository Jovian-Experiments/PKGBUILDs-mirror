...
package() {
  ...
  echo "DISTRIB_ID=SteamOS" >> "$pkgdir/etc/lsb-release"
  echo "DISTRIB_RELEASE=rolling" >> "$pkgdir/etc/lsb-release"
  echo "DISTRIB_CODENAME=Holo" >> "$pkgdir/etc/lsb-release"
  echo "DISTRIB_DESCRIPTION=\"SteamOS Holo\"" >> "$pkgdir/etc/lsb-release"
