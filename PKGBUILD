...
# Holo: this library (with the python-libversion bindings) is used to
# compare package version numbers and help track open bugs and
# security problems. This is not needed in the SteamOS image.
