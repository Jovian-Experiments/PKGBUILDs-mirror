...
source=('inputplumber-0.47.2.tar.gz::https://github.com/ShadowBlip/InputPlumber/archive/v0.47.2.tar.gz'
        ...
        'virtual-usb-0.1.0.tar.gz::https://github.com/ShadowBlip/virtual-usb-rs/archive/4bca5c6fb9f2b63944a286854405e3e7e0b5d259.tar.gz'
...
sha256sums=('0382db89655c7556b415e2d2023f27cf846c14f9f4ca04544bba0b12a0a1f86c'
            ...
            '6a3c0ecfb95fd776a1854debf14ca01491fc351ee4bc0411ac0c5067e1faa1e6'
...
prepare() {
  ...
  cat << EOF >> .cargo/config.toml
    ...
    [source."git+https://github.com/ShadowBlip/virtual-usb-rs.git?rev=4bca5c6fb9f2b63944a286854405e3e7e0b5d259"]
    git = "https://github.com/ShadowBlip/virtual-usb-rs.git"
    rev = "4bca5c6fb9f2b63944a286854405e3e7e0b5d259"
    replace-with = "vendored-sources"

    [source."git+https://github.com/emberian/evdev.git?rev=42b58ee08508b7799322a13bf89121a1d29cf0a2"]
