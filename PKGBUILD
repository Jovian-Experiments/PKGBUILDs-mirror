...
pkgbase=linux-neptune-519-wip
_tag=5.19.0-valve1-wip
pkgver=${_tag//-/.}
pkgrel=2
pkgdesc='Linux'
url="https://gitlab.steamos.cloud/jupiter/linux-integration/-/tree/cristicc/mainline-5.19"
arch=(x86_64)
license=(GPL2)
makedepends=(
...
source=(
  "$_srcname::git+ssh://git@gitlab.steamos.cloud/jupiter/linux-integration.git#branch=cristicc/mainline-5.19"
