...
pkgver=5.40.0
_baseversion="${pkgver%.*}"
pkgrel=1.1 # Holo: Fix CVE-2024-56406
...
sha512sums=('a2fb1a24c6367b4043f4e929b2d74fc3bad1415e53b791ed1f219f1701064ae21b2bd3164ba95fcf24eaf458bd54433024ccae43725c0bb82a1ec6a98dc7052d'
            '61d93ff1ea6e1848b3a207ef231b13dcc33b0bfdc753034fcf62d3c794fb34cabcdea4c73f8e3115b79de90c5e5220555f10d06177621d359066e1bf6001c57d'
...
prepare() {
  ...
  # Holo: https://www.openwall.com/lists/oss-security/2025/04/13/3
  patch -Np1 < "$srcdir/fix-cve-2024-56406.patch"
