...
pkgname=scx-scheds
gitname=scx
pkgver=1.1.2.linux.steamos
pkgrel=2.1 # Part of tag (probably shouldn't be - use N.M suffix for packaging-only changes)
...
source=("git+ssh://git@gitlab.steamos.cloud/holo/scx.git#tag=v$pkgver-${pkgrel%.*}")
sha256sums=('fe5332de5777b3a3185dcfed4cbc55b9459cfd5614bfa9bbbaf732a993cf457a')
options=(!lto)
