...
pkgbase=mesa-radv
# SteamOS:
# only build RADV, the rest comes from upstream/Arch Mesa
pkgname=(
#  mesa
#  opencl-mesa
#  vulkan-asahi
...
_tag=steamos-26.05.12
pkgver=26.2.0_devel.222109.steamos_26.05.12
...
sha256sums=('d449929a4a2cf938d904d3392b8cd129b62a2417a427fbfe838ccd9a674b552d'
...
b2sums=('57f14cd5ca4347d2dabffa50120eaa557e546995273cbe648b52717eba1be6ed51f3f5224e45ffc80ea3742ae7c0e82e64f9906d5c6d05b67fb765b9bd4f33d5'
...
build() {
  local meson_options=(
    ...
    # SteamOS: Specific build options.
    -D gallium-drivers=
  ...
  arch-meson steamos-mesa build "${meson_options[@]}"
...
#  install -Dm644 mesa-$_pkgver/docs/license.rst -t "$pkgdir/usr/share/licenses/$pkgname"
  ...
  # SteamOS:
  # Install libvulkan_radeon.so, radeon_icd.x86_64.json and
